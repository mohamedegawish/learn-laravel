...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li><a href="#"><i class="fas fa-handshake"></i> <span>Leads</span></a></li>
            <li><a href="#"><i class="fas fa-tasks"></i> <span>Tasks</span></a></li>
            <li><a href="#"><i class="fas fa-dollar-sign"></i> <span>Deals</span></a></li>
    ...
    <div class="page-container">
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h1>Dashboard</h1>
                <p>Welcome back, Jane! Here's a summary of your activity.</p>
            </div>
            ...
            <div class="stats-grid">
                <div class="stat-card blue">
                    <div class="info">
                        ...
                        <div class="stat-change positive"><i class="fas fa-arrow-up"></i> 20.1%</div>
                    </div>
                ...
                <div class="stat-card orange">
                    <div class="info">
                        ...
                        <div class="stat-change positive"><i class="fas fa-arrow-up"></i> 8.2%</div>
                    </div>
                ...
                <div class="stat-card red">
                    <div class="info">
                        ...
                        <div class="stat-change negative"><i class="fas fa-arrow-down"></i> 2 Overdue</div>
                    </div>
            ...
            <div class="content-section">
                <div class="section-header">
                    <h3>Recent Leads</h3>
                    <a href="#" class="btn btn-primary"><i class="fas fa-plus"></i> Add New Lead</a>
                </div>
                <div class="table-wrapper">
                    <table class="data-table">
                        <thead>
                            <tr>
                                <th>Client Name</th><th>Company</th><th>Status</th><th>Value</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td><div class="client-info"><div class="client-avatar">AJ</div><span>Alex Johnson</span></div></td>
                                <td>TechCorp</td>
                                <td><span class="status-tag status-new"><i class="fas fa-circle"></i> New</span></td>
                                <td>$5,000</td>
                            </tr>
                            <tr>
                                <td><div class="client-info"><div class="client-avatar">SM</div><span>Samantha Miller</span></div></td>
                                <td>Innovate LLC</td>
                                <td><span class="status-tag status-contacted"><i class="fas fa-circle"></i> Contacted</span></td>
                                <td>$12,300</td>
                            </tr>
                            <tr>
                                <td><div class="client-info"><div class="client-avatar">BW</div><span>Bruce Wayne</span></div></td>
                                <td>Wayne Enterprises</td>
                                <td><span class="status-tag status-new"><i class="fas fa-circle"></i> New</span></td>
                                <td>$250,000</td>
                            </tr>
                            <tr>
                                <td><div class="client-info"><div class="client-avatar">DP</div><span>Diana Prince</span></div></td>
                                <td>Themyscira Export</td>
                                <td><span class="status-tag status-unqualified"><i class="fas fa-circle"></i> Unqualified</span></td>
                                <td>$800</td>
                            </tr>
                        </tbody>
                    </table>
